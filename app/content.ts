...
export const projects: Project[] = [
  ...
  },
  {
    ...
    links: [{ label: "Download for Windows", url: "https://github.com/jenna-studio/dreamspace-releases" }, { label: "Download on MacOS App Store", url: "https://apps.apple.com/kr/app/dreamspace-for-students/id6806326816?l=en-GB&mt=12" }],
  },
  {
    title: "CS UniVerse", category: "web-app",
    description: "An all-in-one workspace for computer science students to code, study, and collaborate in the browser. A Monaco editor and an in-page terminal sit next to the coursework, so reading a problem, writing the solution, and running it happen in one place. Assignments feed an integrated calendar, progress analytics track the term, and a Baekjoon integration brings practice problems into the same view.",
    tags: ["Next.js", "React"], type: "Web Application", year: "2026", image: "/media/csuniverse-thumbnail.png",
    links: [{ label: "Learn More", url: "https://csuniverse.org" }, { label: "Open Workspace", url: "https://csuniverse.org/signup" }],
  },
  {
    title: "Lecture Reaction Tool", category: "tools",
    description: "A transparent overlay that shows a professor how the room is following, live on top of whatever they are presenting. Students open a URL, type a 5-character class code, and tap understand, confused, too fast, again, or two fault reports for a washed-out projector or a dead mic. Reactions float over the slides and questions stack by votes down the right edge. No install, no login, and the overlay is the entire professor interface.",
    tags: ["Tauri", "Rust", "TypeScript"], type: "Desktop Overlay", year: "2026", image: "/media/lecture-reaction-thumbnail.png",
    links: [{ label: "View Code", url: "https://github.com/jenna-studio/lecture-reaction" }, { label: "Set It Up", url: "https://github.com/jenna-studio/lecture-reaction#running-it" }],
  },
  {
    title: "Agent Track Dashboard", category: "tools",
    description: "A kanban-based monitoring system for AI agents, served over MCP so the agents report into it as they work. Cards move through the task lifecycle in real time, each one opening onto the files that changed and the reasoning behind them, with token usage and completion metrics collected per agent so a long run stays reviewable after the fact.",
  ...
  },
  {
    ...
    description: "A Korean social platform for finding someone to do things with. Activities are posted to a Kakao Maps view across dining, fitness, and hobby categories, so joining one is a matter of seeing what is happening nearby. Groups get real-time chat, and mutual ratings after a meetup keep the friend list built on people who actually showed up.",
