...
const portfolioEntries: PortfolioEntry[] = [
  ...
  {
    id: "english-tutor", category: "tools", title: "Your English Tutor", subtitle: "Custom ChatGPT", cover: "/media/portfolio-thumbnails/english-tutor-thumbnail.png",
  ...
  {
    id: "travel-map", category: "creation", title: "Travel Maps Design", subtitle: "Create cruise travel maps", cover: "/media/portfolio-thumbnails/travel-map-thumbnail.png",
  ...
  {
    id: "chrome-theme", category: "ui-ux", title: "Chrome Theme Extension", subtitle: "Browser Extension", cover: "/media/portfolio-thumbnails/chrome-theme-thumbnail.png",
  ...
  {
    id: "humidifier", category: "3d", title: "Raindrop ASMR LED Humidifier", subtitle: "3D Modeling/Printing", cover: "/media/portfolio-thumbnails/asmr-humidifier-thumbnail.png",
...
function DetailContent({ id }: { id: string }) {
  if (id === "ai-music") return (
    <>
      <div className="embed-grid">
        <iframe src="https://open.spotify.com/embed/artist/10YbtQS5pUWj10uNEpFxZr?utm_source=generator" title="Jenna Studio on Spotify" loading="lazy" allow="autoplay; clipboard-write; encrypted-media; fullscreen; picture-in-picture" />
        {["9k24PlgJPbM", "-HvfdrE5JPE", "rld8To_ymEk"].map((video) => <iframe src={`https://www.youtube.com/embed/${video}`} title="Jenna Studio music video" loading="lazy" allowFullScreen key={video} />)}
      </div>
  ...
  if (id === "travel-map") return (
    <><div className="media-gallery">{travelMaps.map(([file, alt]) => <img src={`/media/travel-maps/${file}`} alt={alt} key={file} />)}</div><div className="card-actions"><a href="https://lifejourney.co.kr" target="_blank" rel="noreferrer">Visit Website ↗</a></div></>
  );
  ...
  if (id === "humidifier") return <div className="media-gallery media-gallery-two"><img src="/media/portfolio-thumbnails/asmr-humidifier-thumbnail.png" alt="ASMR Humidifier" /><img src="/media/portfolio-thumbnails/asmr-humidifier-panel.png" alt="ASMR Humidifier panel" /></div>;
